...
public class MockCachedStore extends CachedBDBStore<String, String> {

	public MockCachedStore(String dbPath, String dbName, boolean isReadOnly,
			int maxMemoryPercent) {
		super(dbPath, dbName, isReadOnly, maxMemoryPercent, true, 1);
	}
