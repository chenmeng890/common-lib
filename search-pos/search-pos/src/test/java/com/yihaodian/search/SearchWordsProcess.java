...
public class SearchWordsProcess {
	...
	private List<String> split(String line) {
		try {
			...
			while (tokenStream.incrementToken()) {
				strSplited.add(new String(term.buffer(), 0, term.length()));
			}
			return strSplited;
		} catch (IOException e) {
	...
	public static void main(String[] args) throws Exception {
		...
		//process.export_products("D:/workspace/branchs/SearchPOS/search-pos/data");
		process.csv_wordmark("D:/workspace/branchs/SearchPOS/search-pos/data");
	}
